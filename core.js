...
export const SAMPLERS = ['k_euler_ancestral','k_euler','k_dpmpp_2m','k_dpmpp_2m_sde','k_dpmpp_sde','k_dpmpp_2s_ancestral','k_dpm_fast','ddim'];
export const SAMPLER_LABELS=Object.freeze({k_euler_ancestral:'Euler Ancestral',k_euler:'Euler',k_dpmpp_2m:'DPM++ 2M',k_dpmpp_2m_sde:'DPM++ 2M SDE',k_dpmpp_sde:'DPM++ SDE',k_dpmpp_2s_ancestral:'DPM++ 2S Ancestral',k_dpm_fast:'DPM Fast',ddim:'DDIM'});
